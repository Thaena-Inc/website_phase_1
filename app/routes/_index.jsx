...
function FlipCard({card, className = ""}) {
  ...
  return (
    <div className={`relative ${className}`}>
      <div 
        className={`relative w-full h-full transition-opacity duration-300 ${isFlipped ? 'opacity-0 pointer-events-none' : 'opacity-100'}`}
      >
        <button
          onClick={() => setIsFlipped(true)}
          className="w-full h-full flex flex-col items-end justify-between p-6 md:p-8 rounded-xl border border-[#EDE7DE] shadow-sm hover:shadow-md transition-shadow bg-white text-left"
        >
      ...
      <div 
        className={`absolute inset-0 transition-opacity duration-300 ${isFlipped ? 'opacity-100' : 'opacity-0 pointer-events-none'}`}
      >
        <div className="w-full h-full flex flex-col justify-between p-6 md:p-8 rounded-xl border border-deep-purple/40 shadow-lg bg-white">
          ...
          <div className="w-full max-w-[1100px] min-w-[300px] px-6 md:px-8 lg:px-12 py-16 md:py-24">
            <div className="flex flex-col items-start gap-4 md:gap-6">
              ...
              <div className="flex flex-col sm:flex-row items-center gap-4 ml-0 sm:ml-auto">
                ...
                >
                  <span className="font-mono text-[16px] font-medium leading-[24px] text-deep-purple">
                    Shop Now
                  </span>
                  <svg 
                    width="11" 
                ...
                <Link 
                  to="/affiliate"
                  className="flex items-center justify-center h-[56px] px-[42px] rounded-[12px] border-2 border-warm-brown bg-transparent hover:bg-warm-brown/5 transition-colors w-full sm:w-auto"
                >
                  <span className="font-mono text-[16px] font-medium leading-[24px] text-slate-dark">
                    Learn More
                  </span>
                </Link>
              </div>
