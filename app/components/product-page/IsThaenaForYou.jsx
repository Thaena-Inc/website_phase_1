  ...
  return (
    ...
    <div className="max-w-[1280px] mx-auto px-6 md:px-12 lg:px-24 py-20">
      ...
      <div className="flex flex-wrap gap-6 mb-16">
        ...
        <div className="w-full lg:w-[calc(50%-12px)] bg-white rounded-md border-t border-r border-b border-l-4 border-t-teal-green/30 border-r-teal-green/30 border-b-teal-green/30 border-l-teal-dark shadow-sm p-8 flex flex-col gap-5">
